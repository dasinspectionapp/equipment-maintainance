        ...
        <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 text-sm text-white/80">
              A Government of Karnataka undertaking responsible for power distribution across Bengaluru city and adjacent
              districts. BESCOM is committed to delivering reliable power, strengthening infrastructure and enabling
