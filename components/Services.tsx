      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-slate-600">
            BESCOM enables seamless digital interactions for consumers, industries and partners, ensuring convenient access
            to payments, applications, approvals and updates.
          </p>
        </div>
