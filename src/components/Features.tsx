      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base text-slate-600">
            BESCOM is transforming the power distribution landscape through technology adoption, sustainability and citizen-first
            programmes backed by robust infrastructure.
          </p>
        </div>
